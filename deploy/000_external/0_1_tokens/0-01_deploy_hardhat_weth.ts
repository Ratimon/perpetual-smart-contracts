...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  const WETHResult = await deploy(deploymentName, {contract: "MockWeth", from: deployer, args: Object.values(WETHArgs), log: true,skipIfAlreadyDeployed: true});
...
export default func;
func.tags = ["0-1-01","0-1","weth","token",'external'];
